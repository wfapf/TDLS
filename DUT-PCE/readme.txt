#
#  WFA Test Engine Source Code (DUT and Control PC) Revision 3.1.2 (June 30, 2010)
...
# Revision: 03.1.1 April, 2010         Sigma WTE release

0. Introduction
   This source code package contains a sample Linux implementation of the DUT code for 
   Wi-Fi Alliance Sigma (former Wi-Fi Test Engine).  This DUT code includes the Wi-Fi Traffic Generator which is used for PC-ENDPOINT as well.  
...
************************** IMPORTANT****************************************
This release intends to support Certified N based products. It is also capable to support the base-line programs WPA2 (a/b/g), 
and other optional programs such as WMM, WMM-Power-Save, Voice-Personal, and upcoming programs (experimenting) like WMM-AC 
and Voice Enterprise.

For WMM-PS, make sure to uncomment the line to build WMM-PS and comment out 
original build-line in "Makefile.inc".

For PC-ENDPOINT, use the PC-ENDPOINT buildline in "Makefile.inc"

0. Check build utilities
   run "buildEssentials.sh" that checks and downloads the utilities for building
   the linux source
...
2. Installing the software
   ...
   b. MUST copy all scripts in scripts/* to /usr/local/sbin on the Linux DUT. 
...
3. Running the software
   ...
   3.3 Console using Python Scripts (Sigma)
   ...
   3.5 Test Console with Python Script
       see 3.3
   ...
   3.8 Running WMM-Power Save
    ...
    For details, 
            please refer the WMM-Power Save Techops Manual and Test Plan as well as the WMM-PS specification.
   
    3.9 Building for PC-ENDPOINT   
       a. go to WTGService/
       b. run 'Make'
       c. run "installSigmaWTG.sh"
  
    The PC-ENDPOINT will automatically start.
